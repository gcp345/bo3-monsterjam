...
function CPGameOptionsDisabled()
	if MapVoteTimerActive() then
		return true
	elseif not CoD.GameOptions.GameModeAndArea then
		return true
	end
	return false
end

function MJStartCustomButtonDisabled()
	local mapName = Dvar.ui_mapname:get() or "cp_mi_eth_prologue"
	if MapVoteTimerActive() then
		return true
	elseif not CoD.GameOptions.GameModeAndArea then
		return true
...
CoD.LobbyButtons.CP_EDIT_GAME_RULES = {
	stringRef = "GAME SETTINGS", 
	action = OpenMJGamesettingsMenu, 
	customId = "btnEditGameRules", 
	disabledFunc = CPGameOptionsDisabled, 
	starterPack = CoD.LobbyButtons.STARTERPACK_UPGRADE
}
CoD.LobbyButtons.MJ_SELECT_TRUCK = {
	stringRef = "UI_MENU_TRUCKSELECT", 
	action = OpenMJTruckSelection, 
	customId = "btnBubblegumBuffs", 
	starterPack = CoD.LobbyButtons.STARTERPACK_UPGRADE,
	--newBreadcrumbFunc = Gunsmith_AnyNewWeaponsOrAttachments
}
CoD.LobbyButtons.MJ_VIEW_STATS = {
	stringRef = "MENU_STATS_CAPS", 
	action = OpenMJStats, 
	customId = "btnBubblegumBuffs", 
	starterPack = CoD.LobbyButtons.STARTERPACK_UPGRADE,
	--newBreadcrumbFunc = Gunsmith_AnyNewWeaponsOrAttachments
}
CoD.LobbyButtons.MJ_STARTGAME = {
	stringRef = "MENU_START_GAME_CAPS",
	action = LobbyOnlineCustomLaunchGame_SelectionList,
	customId = "btnStartCustomGame",
	disabledFunc = MJStartCustomButtonDisabled,
	starterPack = CoD.LobbyButtons.STARTERPACK_UPGRADE
}
CoD.LobbyButtons.MJ_CUSTOM_GAMES = {
	stringRef = "MENU_PRIVATE_GAME_CAPS",
	action = NavigateToLobby_SelectionList,
	param = "CPLobbyOnlineCustomGame",
	customId = "btnCustomMatch",
	starterPack = CoD.LobbyButtons.STARTERPACK_UPGRADE
}
CoD.LobbyButtons.CP_ONLINE = {
	stringRef = "UI_MENU_MONSTERJAM_CAPS",
...
CoD.LobbyButtons.MJ_ONLINE = {
	stringRef = "UI_MENU_MONSTERJAM_CAPS",
	action = NavigateToLobby_SelectionListDOA,
	param = {
...
CoD.LobbyButtons.CP_SELECT_MISSION = {
	stringRef = "MENU_CHOOSE_MAP_CAPS",
